...
Debido a la gran cantidad de datos, se ha decidido realizar una representación gráfica de los resultados para poder dar una interpretación de los mismos. Los gráficos que se muestran en esta memoria son los siguientes:
...
podemos ver, \emph{a groso modo}, que la mayoría de clases Python no está representada en los diagramas UML, sin tener en cuenta
