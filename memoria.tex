...
están veríficados. Esta lista incluía proyectos con distintos tipos de lenguaje de programación,
...
\begin{itemize}
  ...
  \item Gráfica que se representa el porcentaje de clases de Python representadas con UML frente a el total
  de clases de Python
  \item Gráfica de dos proyectos de ejemplo para interpretar las correciones realizadas por mayúsculas/minúsculas y
  por distancia hamming
\end{itemize}
...
Por lo tanto, con esta simple reperesentación, se puede extraer que la mayoría de clases de Python no tienen su equivalente
en UML, o lo que es lo mismo, no están modeladas en UML.

Para demostrar esto de manera númerica nos basamos en la siguiente figura:
...
el 86,90\% de las clases, no se les ha aplicado ninguna correción, por lo que se entiende que si no
...
\subsection{Correciones}
\label{subsec:correcciones}
Las correciones aplicadas representan un 13,10\% de la intersección de clases UML y Python, tal como hemos visto en la figura
...
\begin{figure}[htb]
  ...
  \caption{Proyectos de ejemplo de correciones}
...
que no estaban modeladas antes de la correción.
...
y poder hacer una interpretación de los resultados obtenidos. El disponer de estos proyectos veríficados
...
indicaba una URL de un proyecto de GitHub, y esta devolvía unos parametros para poder
...
\begin{enumerate}
  \item Protocolos para la transmisión de audio y video, en la cual aprendí sobre el uso de Python y el uso de sus librerias.
  \item Laboratorios de tecnologías audiovisuales en la web, en la cual aprendí sobre el el desarrollo web tanto del lado cliente
...
\begin{enumerate}
  ...
  \item Capacidad de trabajo autónomo, con resolución de cuestiones con busquedas en internet o libros.
  \item Planifición de un proyecto.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item La creación de la memoria con \LaTeX{}. El desarrollo de esta memoría se ha realizado con \LaTeX{}, herramienta que nunca había
...
Al tratarse de una herramienta píloto, presenta varios trabajos a futuro, para poder ampliar el uso de esta aplicación.
...
\begin{enumerate}
  ...
  \item \textbf{Aumentar la complejidad de UML.} En este aspecto existe un mundo de mejora, en el que vamos a plantear posibles
  ...
  \begin{itemize}
    ...
    \item Actualmente solo nos fijamos en archivos .xmi de UML, que son los estándarizados. Podemos extraer información de otros
...
quería hacer algo sobre programar, pero que tuviera tambien una parte Front, no solo Back.

Para poder desarrollar algo así, pregunte a los profesores de programación, hasta que Gregorio me comento la posibilidad de realizar
