...
El presente trabajo se basa en la creación de una aplicación web para analizar proyectos en
GitHub, dando métricas respecto a calidad de código Python-UML. De esta manera, se
podrá obtener un valor de representación de UML en Python. Los resultados obtenidos
servirán para conocer cual es el uso que se le da a UML en un proyecto.
\newline

La aplicación web se desarrolla con HTML5, BootStrap y CSS3
del lado del cliente, y con Django, Ctags y Python en el lado servidor.
\newline

Surge la necesidad de esta aplicación web debido a un primer análisis sobre el total
de repositorios de GitHub, en el cual se obtiene un bajo porcentaje de archivos identificados para UML.
De este modo, la finalidad de la aplicación es ayudar a entender cuál es el uso que se hace de UML
en cada proyecto, para comprender la poca utilización de UML a modo general.
...
ya que menos del 1\% de todos los proyectos de GitHub son los que usan UML.

Este proyecto pretende dar a apoyo al estudio realizado por la URJC y la Universidad de Gotemburgo
...
\begin{itemize}
  ...
  \item Extración de los nombres de las clases de Python y UML, para poder comprobar cuales de ellas
  están representadas.
  \item Optimizar código para los proyectos disponibles, tras realizar pruebas de test cone llos.
...
para el desarrollo software, estandarizado en 2005, aunque el primer borrador fué lanzado
...
Debido al desarrollo de este trabajo, haremos especial incapié en los diagramas de clases.
...
mostrando las clases con sus atributos y sus interaciones tales como herencias, asociaciones, etc.
...
\begin{figure}[htb]
  ...
  \caption{Diagrama de definción de UML}
  \label{fig:construml}
\end{figure}
...
\begin{itemize}
  ...
  \item Asosicación: relación de objetos que colaboran entre si.
...
\subsection{Django}
\label{subsec:django}
\textbf{Django}\footnote{https://www.djangoproject.com/} es un framework opensource de desarrollo web para crear aplicaciones Web de alta calidad
...
que no es necesario el uso de Flash, ni de instalar nada de forma adiccional.

\subsection{CSS3}
\label{subsec:CSS3}
\textbf{CSS3} (Cascading StyleSheets) es la úlima evolución de las hojas de estilo en casacada CSS, que es un lenguaje de diseño gráfico para la presentación de documentos
...
un botón para proceder al envio de la url y un link para consultar los proyectos disponibles.
El método de envio del formulario es mediante POST, ya que permite que los datos enviados no sean visibles al usuario,
y no llegen datos inesperados a nuestro servidor.
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    Para nuestro caso, se ha creado un único modelo llamado Project, y con las propiedades necesarias para mostrar los
...
número de clases de Python, intersección de clases, número de clases sin correción, número de clases
corregidas por errores de mayúsculas y número de clases corregidas por errores en distancia hamming.


\subsubsection{GitHub}
\label{subsubsec:github}
Se realiza una descarga del repositorio para poder realizar el analisis del proyecto. La descarga
se hace ejecutando el siguiente codigo:
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    extraidas todas las etiquetas, hay que quedarse unicamente con aquellas consideras UML. Despues de esto,
  ...
  \begin{enumerate}
    \item \textbf{Análisis sin correciones:} se calcula la intersección existente entre los dos sets. Es decir,
    se crea un sets nuevo, con los nombres de las clases que tengan en común.
    ...
    \item \textbf{Análisis con correciones por minúsculas:} se convierte las clases en minúsculas y se vuelve a realizar
    ...
    \item \textbf{Análisis con correciones por distancia hamming:} la distancia hamming entre dos palabras es el número
    de letras que tienen diferentes. Es decir, la distancia hamming entre \textit{padre} y \textit{madre} es 1.
  ...
  Una vez hechas todas las correciones, se devuelven los resultados obtenidos:
  \begin{itemize}
    \item Número total de clases.
    \item Número de clases obtenidas sin corregir.
    \item Número de clases obtenidas por correción de minúsculas.
    \item Número de clases obtenidas por correción de distancia hamming.
...
Para realizar todo este proceso se utiliza 3 archivos, de manera que las funciones esten desacopladas
