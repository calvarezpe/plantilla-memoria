...
de métricas para su análisis. Por lo tanto, se trata de una herramienta piloto.
...
\begin{enumerate}
  \item Reunión con Gregorio dónde me explica su idea del tema del proyecto y el objetivo que se persigue.
  \item Estudiar y entender UML, para qué se usa, cómo es, dónde se usa...
  \item Definición de la arquitectura de la aplicación.
  \item Reunión con Gregorio para aclarar dudas sobre UML y mostrar la arquitectura de la aplicación.
  ...
  \begin{itemize}
    ...
    \item Especificación del módelo de datos.
...
quería hacer algo sobre programar, pero que tuviera también una parte Front, no solo Back.
...
\end{lstlisting}
De esta manera nuestro servidor ya empieza a escuchar en el puerto 8000 (default).
