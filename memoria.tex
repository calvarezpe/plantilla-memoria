...
Debido a las cualidades que tiene Django, se decide utilizar para la creación de la parte Front del proyecto, la página web de presentación de resultados. La justificación de la elección de Django es porque tenemos que dar resultados de distintos proyectos, tarea que facilita Django con el MVC, al cual se le pasan los datos obtenidos en la consulta de la BBDD a la plantilla, y Django ya crea el HTML resultante.
...
Se decide usar este lenguaje de programación debido a las características que presenta que es de alto nivel y porque es el lenguaje que más me ha gustado en los años de universidad. Con Python se ha desarrollado todo el proyecto, tanto el servidor con Django como toda la lógica de la herramienta para analizar el código fuente y su modelado UML.
